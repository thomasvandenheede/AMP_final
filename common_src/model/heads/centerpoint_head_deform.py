...
from ..head_utils.deform_conv import DeformConvModule
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------

class SeparateHeadDeform(nn.Module):
    ...
    def __init__(self,
        ...
        for head in self.heads:
            ...
            for i in range(num_conv - 1):
                conv_layers.append(
                    DeformConvModule( # Use DeformConvModule or ConvModule
                        c_in,
                        head_conv,
...
class CenterHeadDeform(nn.Module):
    ...
    def __init__(self,
        ...
        self.shared_conv = DeformConvModule(
            in_channels,            # same input channels
            share_conv_channel,     # same output channels
            kernel_size=3,
            stride=1,
            padding=1,
            bias=(bias!='auto'),
        ...
        for num_cls in num_classes:
            ...
            self.task_heads.append(SeparateHeadDeform(**separate_head))
