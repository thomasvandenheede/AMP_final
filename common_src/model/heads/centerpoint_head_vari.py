...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
from ..losses import L1Loss, VarifocalLoss
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
class CenterHeadVari(nn.Module):
    ...
    def __init__(self,
        ...
        self.loss_cls = VarifocalLoss(**loss_cls) #--------------------------------------------------------------------
    ...
    def loss(self, gt_bboxes_3d, gt_labels_3d, preds_dicts, **kwargs):
        ...
        for task_id, preds_dict in enumerate(preds_dicts):
            # heatmap focal loss
            pred_heatmap_logits = preds_dict[0]['heatmap'] #--------------------------------------------------------------
            num_pos = heatmaps[task_id].eq(1).float().sum().item()
            pred_heatmap_logits = pred_heatmap_logits.cuda() #----------------------------------------------------
            gt_heatmap = heatmaps[task_id].cuda() #---------------------------------------------------------------
